    ...
    <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 relative">
      <div className="max-w-4xl mx-auto text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          {/* Logo and Brand */}
          <div className="flex items-center justify-center space-x-4 mb-8 brand">
            ...
            <h1 className="text-5xl sm:text-6xl font-black gradient-text">Qarīn.ai</h1>
          </div>

          {/* Tagline */}
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
            Self-hosted AI Agent Builder<br />
            <span className="gradient-text">for Any Website or System</span>
          </h2>

          {/* Description */}
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            No coding required. Connect to any OpenAI-compatible LLM, 
          ...
          <button
            ...
            className="group bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 neon-glow hover:scale-105 inline-flex items-center space-x-2 text-lg"
          >
        ...
        <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-cyan-400 rounded-full animate-pulse opacity-40"></div>
